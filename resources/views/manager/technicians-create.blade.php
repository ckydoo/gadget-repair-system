...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Add New Technician</h1>
                <p class="text-gray-600">Create a new technician account</p>
            </div>
        </div>
    </div>
    ...
    <!-- Form -->
    <form action="{{ route('manager.technicians.store') }}" method="POST" class="bg-white rounded-lg shadow-lg p-8">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    ...
                    <label class="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-blue-50 transition">
                        <input type="checkbox"
                               ...
                               value="{{ $category->id }}"
                               {{ in_array($category->id, old('specializations', [])) ? 'checked' : '' }}
            ...
            <div class="md:col-span-2">
                <label class="flex items-center cursor-pointer">
                    ...
                    <span class="ml-3">
                        <span class="text-sm font-semibold text-gray-700">Set as Available</span>
                        <span class="block text-sm text-gray-500">Technician will be available for task assignments immediately</span>
                    </span>
                </label>
            </div>
        </div>
